...
class ActiveSimulator_v2(ActiveSimulator_v1):
    ...
    def __init__(self, paths="1", random_seed=None) -> None:
        # Fix parameter name to match parent classes
        ...
        # Create a local RNG for congestion simulation
        # We're already using self.drop_rng for packet drops from parent class
    ...
    def _generate_congestion_intervals(self):
        ...
        # Use congestion_rng instead of rng
        self.congestion_rng.shuffle(something)
        ...
        # Use congestion_rng for random weights

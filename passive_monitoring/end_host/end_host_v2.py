...
from passive_monitoring.end_host.end_host_monitor import EndHostEstimation
...
evolution_2_with_congestion(100, 1000, 100, True, "trimmed")
evolution_2_with_congestion(100, 1000, 100, True, "median_filter")
evolution_2_with_congestion(100, 1000, 100, True, "threshold")